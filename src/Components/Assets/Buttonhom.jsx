          ...
          >
            <defs>
              <linearGradient
                ...
                y2="0%"
              >
                <stop offset="0%" stopColor="#3b0f28" />
                <stop offset="35%" stopColor="#8d2e63" />
                <stop offset="68%" stopColor="#ff5d94" />
                <stop offset="100%" stopColor="#ffb7c9" />
              </linearGradient>
            </defs>
            <g id="Layer_x0020_1">
          ...
          >
            <defs>
              <linearGradient
                ...
                y2="0%"
              >
                <stop offset="0%" stopColor="#4a1831" />
                <stop offset="38%" stopColor="#a63c73" />
                <stop offset="72%" stopColor="#ff739f" />
          ...
          >
            <defs>
              <linearGradient
                ...
                y2="0%"
              >
                <stop offset="0%" stopColor="#341020" />
                <stop offset="34%" stopColor="#7f2857" />
                <stop offset="70%" stopColor="#ff5b8f" />
...
const StyledWrapper = styled.div`
  @import url("https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;600&family=Proza+Libre:wght@400;500&display=swap");
